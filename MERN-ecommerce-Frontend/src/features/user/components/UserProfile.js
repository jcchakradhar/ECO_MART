    ...
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <h1 className="text-4xl my-5 font-bold tracking-tight text-gray-900"> {(userInfo?.name || 'New User').toUpperCase()} </h1>
        
          {userInfo?.email && (
            <h3 className="text-xl my-2 font-medium tracking-tight text-gray-700">
              {userInfo.email}
            </h3>
          )}
          {userInfo.role === 'admin' && (
